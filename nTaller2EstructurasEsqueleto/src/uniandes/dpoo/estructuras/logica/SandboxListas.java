...
public class SandboxListas
{
    ...
    public List<Integer> getCopiaEnteros( )
    {
    	...
    	copia.addAll(this.listaEnteros);
        return copia;
    }
    ...
    public List<String> getCopiaCadenas( )
    {
    	...
    	copia.addAll(this.listaCadenas);
        return copia;
    }
    ...
    public void reiniciarArregloEnteros( double[] valores )
    {
    	 ...
    	 for (double cosa : valores) {
    	        this.listaEnteros.add((int) cosa);
    	    }
    ...
    {
    	{
       	 ...
       	 for (Object cosa : objetos) {
       	        this.listaCadenas.add(cosa.toString());
       	    }
    ...
    public void volverPositivos( )
    {
    	...
    	for (int i = 0; i < size; i++) {
    		int val = this.listaEnteros.get(i);
    		if (val < 0)
    			this.listaEnteros.set(i, val * -1);
    	}
    ...
    {
    	this.listaEnteros.sort((a, b) -> b.compareTo(a));
    }
    ...
    public int contarEnterosRepetidos() {
        ...
        for (Integer num : listaEnteros) {
            if (cont.contains(num)) {
                continue;
            }
            
            int veces = 0;
            for (Integer otro : listaEnteros) {
                if (num.equals(otro)) {
                    veces++;
                }
            }
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
    	...
    	for (int i = 0; i < cantidad; i++) {
    		int u = (int)(Math.random() * (maximo - minimo + 1)) + minimo;
    		this.listaEnteros.add(u);
    	}
