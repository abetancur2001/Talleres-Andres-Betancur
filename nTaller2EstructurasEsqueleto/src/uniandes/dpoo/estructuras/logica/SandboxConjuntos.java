...
public class SandboxConjuntos
{
    ...
    {
    	this.volverMayusculas();
    	String s = cadena.toUpperCase();
    	this.eliminarCadena(s);
    }
    ...
    {
    	this.getCadenasComoLista();
    	String t = this.getPrimera();
    	this.arbolCadenas.remove(t);
    }
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
        ...
        for (Object cosa : objetos) {
            arbolCadenas.add(cosa.toString());
        }
    }
    ...
    public void volverMayusculas( )
    {
    	...
    	for (String x : arbolCadenas)
    		oh.add(x.toUpperCase());
    		
        arbolCadenas.clear();
        arbolCadenas.addAll(oh);
    }
    ...
    {
    	TreeSet<String> inv = new TreeSet<>(Collections.reverseOrder());
 
        inv.addAll(arbolCadenas);
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
    	...
    	int i = 0;
        for (String j : otroArreglo)
        	if (!this.arbolCadenas.contains(j))
        		return false;
        return true;
